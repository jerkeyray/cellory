      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="mb-8 grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-[#e5e5e5] bg-white p-6 dark:border-[#2a2a2a] dark:bg-[#0a0a0a]">
            <div className="text-3xl font-bold text-[#1a1a1a] dark:text-white">
              {playbooks.length}
            </div>
            ...
            {playbooks.map((playbook) => {
              ...
              return (
                <Link
                  ...
                  className="group block rounded-xl border border-[#e5e5e5] bg-white p-6 transition-all hover:border-[#ff6b35] hover:shadow-md dark:border-[#2a2a2a] dark:bg-[#0a0a0a] dark:hover:border-[#ff6b35]"
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-[#1a1a1a] group-hover:text-[#ff6b35] dark:text-white dark:group-hover:text-[#ff6b35]">
                        {playbook.title}
                      </h3>
                      ...
                      {/* Preview */}
                      <p className="mt-4 line-clamp-2 text-sm text-[#666] dark:text-[#999]">
                        {playbook.content.split("\n").find((line) => line.trim() && !line.startsWith("#"))}
                      </p>
                    </div>

                    <svg
                      className="ml-4 h-5 w-5 flex-shrink-0 text-[#999] transition-transform group-hover:translate-x-1 group-hover:text-[#ff6b35]"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
